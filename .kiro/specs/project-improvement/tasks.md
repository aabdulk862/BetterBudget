...
- [ ] 1. BigDecimal migration for monetary fields
  - [ ] 1.1 Migrate entity fields from double to BigDecimal
  ...
  - [ ] 1.2 Migrate DTOs to BigDecimal
  ...
  - [ ] 1.3 Refactor service arithmetic to use BigDecimal methods
...
- [ ] 2. Standardize exception handling
  - [ ] 2.1 Replace RuntimeException with BusinessException in services
  ...
  - [ ] 2.2 Expand GlobalExceptionHandler
...
- [ ] 3. Decouple services from HTTP layer
  - [ ] 3.1 Refactor EnvelopeService to return domain objects/DTOs
  ...
  - [ ] 3.2 Refactor EnvelopeHistoryService to return domain objects/DTOs
  ...
  - [ ] 3.3 Refactor TransactionService to return domain objects/DTOs
...
- [ ] 5. Lazy fetching and N+1 resolution
  - [ ] 5.1 Switch all JPA associations to FetchType.LAZY
  ...
  - [ ] 5.2 Add @EntityGraph / JOIN FETCH queries to repositories
...
- [ ] 6. Resolve circular dependency in SecurityConfig
  - [ ] 6.1 Refactor JWTAuthFilter to use ObjectProvider
...
- [ ] 7. Externalize secrets and restrict CORS
  - [ ] 7.1 Externalize backend secrets to environment variables
  ...
  - [ ] 7.2 Restrict CORS to explicit allowed origins
  ...
  - [ ] 7.3 Externalize frontend API base URL
...
- [ ] 8. Input validation with Jakarta Bean Validation
  - [ ] 8.1 Add spring-boot-starter-validation dependency
    - Add `spring-boot-starter-validation` to `pom.xml`
    - _Requirements: 3.1_

  - [ ] 8.2 Add validation annotations to DTOs
  ...
  - [ ] 8.3 Add @Valid to all controller method parameters
...
- [ ] 9. Enforce resource ownership authorization
  - [ ] 9.1 Implement ownership verification in EnvelopeService
  ...
  - [ ] 9.2 Implement ownership verification in TransactionService
...
- [ ] 11. Pagination for list endpoints
  - [ ] 11.1 Add pagination to EnvelopeController and EnvelopeService
  ...
  - [ ] 11.2 Add pagination to TransactionController and TransactionService
    - Accept `page` and `size` query parameters in `GET /transactions`
    - Return `PaginatedResponse<Transaction>`
    - _Requirements: 10.2, 10.4_

  - [ ] 11.3 Add pagination to EnvelopeHistoryController and EnvelopeHistoryService
...
- [ ] 12. REST API design fixes
  ...
  - [ ] 12.4 Remove duplicate /transactions route in frontend
...
- [ ] 14. Frontend error boundaries
  ...
  - [ ] 14.2 Wrap route components with ErrorBoundary
    - Wrap each `<Route>` element in `App.tsx` with `<ErrorBoundary>`
    - _Requirements: 12.3_

- [ ] 15. Frontend loading and error states
  - [ ] 15.1 Add loading and error states to data-fetching components
...
- [ ] 16. Unify frontend styling with MUI ThemeProvider
  - [ ] 16.1 Create global SCSS variables file
  ...
  - [ ] 16.2 Convert CSS files to SCSS
  ...
  - [ ] 16.3 Create MUI ThemeProvider and consolidate button styles
  ...
  - [ ] 16.4 Extract shared two-column layout component
  ...
  - [ ] 16.5 Add focus indicators to interactive elements
    - Add `:focus-visible` outlines to all buttons, links, and form inputs via global styles or MUI theme overrides
    - _Requirements: 17.7_

- [ ] 17. Checkpoint - Ensure frontend builds and all tests pass
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 18. Expand backend test coverage
  - [ ] 18.1 Add controller integration tests with MockMvc
  ...
  - [ ] 18.2 Add security integration tests
  ...
  - [ ] 18.4 Add unit tests for EnvelopeService financial operations
  ...
  - [ ] 18.5 Clean up existing test files and add JaCoCo
...
- [ ] 19. OpenAPI documentation
  - [ ] 19.1 Add springdoc-openapi dependency and configuration
...
- [ ] 20. Docker Compose orchestration
  - [ ] 20.1 Create docker-compose.yml
  ...
  - [ ] 20.2 Update backend Dockerfile to multi-stage build
    - Add Maven build stage and JDK 17 runtime stage
    - _Requirements: 15.3_

- [ ] 21. Project README
  - [ ] 21.1 Create README.md at project root
