    ...
    <Box className="env-container">
      ...
      <Box className="env-text">
        ...
        <Typography variant="body1">
          ...
          <span className="highlight-text">giving your envelope a name</span>,
          like <span className="highlight-text">"Grocery Fund"</span> or{" "}
          <span className="highlight-text">"Vacation Dreams"</span>, to make it
          personal and fun. Then, add your
          <span className="highlight-text">
            {" "}
            current balance so you know exactly where you stand
          </span>
          . Finally, set a{" "}
          <span className="highlight-text">
            spending limit to keep things in check
          </span>{" "}
      ...
      <Box className="env-form">
        ...
        <form onSubmit={handleCreateEnvelope}>
          ...
          <Button
            ...
            sx={{
              marginTop: 2,
              backgroundColor: btnDisabled ? "var(--purple)" : "",
            }}
